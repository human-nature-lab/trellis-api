...
$router->group(['middleware' => 'token'], function () use ($router) {
  ...
  $router->post('hooks/geo/{geoId}/{hookId}',                 [                                                         'uses' => 'HookController@runGeoHook']);
  $router->get('hooks/respondent/{respondentId}',             [                                                         'uses' => 'HookController@respondentHookStatuses']);
  $router->post('hooks/respondent/{respondentId}/{hookId}',   [                                                         'uses' => 'HookController@runRespondentHook']);
