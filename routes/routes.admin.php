...
$router->group([], function () use ($router) {
    ...
    $router->group(['middleware' => 'token'], function () use ($router) {
        ...
        $router->post('study/{studyId}/form/assign',                                'FormController@assignForm');
        $router->post('study/form/{formId}/section/import',                         'FormController@importSection');
        $router->get('study/{studyId}/forms',                                       'RespondentController@getRespondentStudyForms');
        // $router->put('census_form',                                              'FormController@createCensusForm');



        //* Interview Controller Routes *//
        $router->get('study/{id}/interview',                            'InterviewController@getInterviewPage');
        $router->get('study/{id}/interview/count',                      'InterviewController@getInterviewCount');



        //* Study Controller Routes *//
        $router->get('study/parameter/types',                           'QuestionParamController@getParameterTypes');
        ...
        $router->delete('locale/{id}',                                  'LocaleController@removeLocale');
        $router->post('locale/{id}',                                    'LocaleController@updateLocale');
        $router->get('locale',                                          'LocaleController@getAllLocales');
        $router->put('locale',                                          'LocaleController@createLocale');



        //* Group Tag Type Controller Routes *//
        $router->delete('group_tag_type/{id}',                          'GroupTagTypeController@removeGroupTagType');
        $router->get('group_tag_type',                                  'GroupTagTypeController@getAllGroupTagTypes');
        $router->put('group_tag_type',                                  'GroupTagTypeController@createGroupTagType');
        ...
        $router->post('study/{studyId}/respondent/import',              'RespondentController@importRespondents');
        $router->post('study/{studyId}/respondent-photo/import',        'RespondentController@importRespondentPhotos');
        $router->post('respondent-preload-data/import',                 'RespondentController@preloadRespondentData');
        $router->get('respondent/{study_id}/count',                     'RespondentController@getRespondentCountByStudyId');
        $router->get('respondent/{study_id}/search',                    'RespondentController@searchRespondentsByStudyId');
        $router->put('respondent',                                      'RespondentController@createRespondent');
        $router->delete('respondent/{id}',                              'RespondentController@removeRespondent');
        $router->post('respondent/{id}',                                'RespondentController@updateRespondent');
        $router->post('respondent/{respondent_id}/photos',              'RespondentController@addPhoto');
        $router->delete('respondent/{respondent_id}/photo/{photo_id}',  'RespondentController@removeRespondentPhoto');
//        $router->get('study/{study_id}/respondents',                  'RespondentController@getAllRespondentsByStudyId');
        ...
        $router->put('geo/id/locale/{locale_id}',                                   'GeoController@createGeo');
        $router->delete('geo/id/{geo_id}',                                          'GeoController@removeGeo');
        $router->get('geo/id/locale/{locale_id}',                                   'GeoController@getAllGeos');
        $router->get('study/{study_id}/geo',                                        'GeoController@getAllGeosByStudyId');
        $router->get('study/{study_id}/geo/count',                                  'GeoController@getGeoCountByStudyId');
        $router->get('geo/id/{geo_id}',                                             'GeoController@getGeo');
        $router->post('geo/id/{geo_id}',                                            'GeoController@updateGeo');
...
//        $router->get('form')
    ...
    $router->group(['middleware' => ['token', 'role:whitelist,ADMIN']], function () use ($router) {
        ...
        $router->post('report/study/{study_id}/respondents',                        'ReportController@dispatchRespondentReport');
        ...
        $router->post('report/clean',                                               'ReportController@cleanReports');
