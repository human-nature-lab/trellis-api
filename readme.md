- [Trellis API](#trellis-api)
  * [Installation](#installation)
    ...
    + [Install trellis-api](#install-trellis-api)
      ...
      - [Set "admin" user password to "trellispass" (without quotes), to allow login at http://trellislocaldev.net/#/login](#set-admin-user-password-to-trellispass-without-quotes-to-allow-login-at-httptrellislocaldevnet%23login)
