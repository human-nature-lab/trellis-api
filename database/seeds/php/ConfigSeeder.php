    ...
    public function run () {
        ...
        DB::transaction(function () {
            ...
            $defaults = [
                ...
                'debug' => 0,
                'appMode' => 'PROD',
                'formBuilderUrl' => '/form-builder/#/form/{form_id}/builder?token={token}&study={study}&locale={locale}',
                'mapTileLayer.url' => 'https://api.mapbox.com/styles/v1/mapbox/streets-v10/tiles/256/{z}/{x}/{y}?access_token={accessToken}',
                ...
                'sentry.dsn' => '',
                'sentry.offline' => true,
                'sentry.onlineIntervalRate' => 3 * 60 * 1000
            ];

            $private = ['mapTileLayer.accessToken'];
