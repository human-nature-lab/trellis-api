  ...
  public function run () {
    ...
    DB::transaction(function () {
      ...
      $defaults = [
        ...
        'formBuilderUrl' => '/form-builder/#/form/{form_id}/builder?token={token}&study={study}&locale={locale}&apiRoot={apiRoot}',   // The url template to use for the form builder iframe
