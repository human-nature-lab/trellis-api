...
class SimulateMigrate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'trellis:simulate:migrate {--preserve : Don\'t drop database after simulation}';
    ...
    {
        $this->description = 'Simulates migrating database from scratch in ' . DatabaseHelper::escape(config('database.connections.mysql_simulated.database')) . ' database';
