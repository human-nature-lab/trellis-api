...
class CsvFileWriter {
  ...
  public function setHeaderMap($headers) {
  ...
  public function writeRow($row) {
    if (is_array($row)) {
      return $this->writeRowMap($row);
    } else {
      return $this->writeRowObj($row);
    }
  }

  public function writeRowObj(object $rowObj) {
    return $this->writeRowMap((array)$rowObj);
  }

  public function writeRowMap(array $rowMap) {
    $row = [];
